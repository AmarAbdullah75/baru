            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="<?php echo site_url('KaryawanC/save')?>" class="forms-sample" method="post">
                    <div class="form-group">
                      <label for="id">ID Karyawan</label>
                      <input type="text" class="form-control" name="id" id="id" placeholder="Id Karyawan" value="<?php echo $id ?>" readonly>
                    </div>
                    <div class="form-group">
