        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="cart-title">Data Karyawan</h4>
                  <p class="card-description">Input Data</p>
                  <form action="<?php echo site_url('KaryawanC/update')?>" class="forms-sample" method="post">
                    <div class="form-group">
                      <label for="id">ID Karyawan</label>
                      <input type="text" class="form-control" name="id" id="id" placeholder="Id Karyawan" value="<?php echo $karyawan->id ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="nama">Nama Karyawan</label>
                      <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Karyawan" value="<?php echo $karyawan->nama ?>">
                    </div>
                    <div class="form-group">
                      <label for="jenis_kelamin">Jenis Kelamin</label>
                      <select class="form-control" name="jenis_kelamin" id="jenis_kelamin" value="<?php echo $karyawan->jenis_kelamin ?>">
                          <option disabled selected value="<?php echo $karyawan->id ?>"></option>
                    ...
                    <div class="form-group">
                      ...
                      <textarea  class="form-control" name="alamat" id="alamat" rows="4" value="<?php echo $karyawan->alamat ?>"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="jabatan">Jabatan</label>
                      <select class="form-control" name="jabatan" id="jabatan">
                        <option disabled selected value="<?php echo $karyawan->jabatan ?>"></option>
