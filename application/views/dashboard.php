        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?php echo base_url('assets/images/anarcute.jpg')?>" alt="profile"/>
            </a>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome Amar</h3>
                  <h6 class="font-weight-normal mb-0">530.224</h6>
                </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="<?php echo base_url('assets/images/232226.jpg')?>" alt="people">
                  <div class="weather-info">
                    <div class="d-flex" style="color:white;">
                      ...
                      <div class="ml-2" >
                        <h4 class="location font-weight-normal">Cikarang</h4>
